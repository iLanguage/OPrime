    ...
    constructor: {
        value: function Experiment() {
            ...
            this.designHasBeenLoaded = require.read(this.experimentalDesignSrc).then(function(contents) {
                ...
                /* randomize stimuli if preference is set so */
                if (self.randomizeStimuli) {
                    self._currentTestBlock.trials = self.suffle(self._currentTestBlock.trials);
                }
        ...
        value: function() {
            ...
            if (stimulus) {
                ...
                if (this._currentTestBlock && this._currentTestBlock.trials) {
                    ...
                    if (this.randomizeStimuli) {
                        this._currentTestBlock.trials = this.suffle(this._currentTestBlock.trials);
                    }
