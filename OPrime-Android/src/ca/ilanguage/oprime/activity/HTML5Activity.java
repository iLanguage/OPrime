...
public class HTML5Activity extends Activity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case OPrime.PICTURE_TAKEN:
			if (data != null) {
				...
				mWebView.loadUrl("javascript:OPrime.hub.publish('pictureCaptureSucessfullyCompleted','"
						+ pictureFilePath + "');");
				if (D)
					Log.d(TAG, "In the result for PICTURE_TAKEN. "
							+ pictureFilePath);
				break;
			}
		default:
							...
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
									...
									Toast.makeText(getApplicationContext(),
											...
											Toast.LENGTH_LONG).show();
									result.confirm(userInput.getText()
											.toString());
								}
							})
	...
	protected void onDestroy() {
		...
		if (mJavaScriptInterface.mListenForEndAudioInterval != null
				&& !mJavaScriptInterface.mListenForEndAudioInterval
						.isCancelled()) {
